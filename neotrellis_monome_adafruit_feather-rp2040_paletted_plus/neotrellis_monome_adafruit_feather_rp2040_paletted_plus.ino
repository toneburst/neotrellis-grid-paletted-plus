...
const byte I2C_SCL = 3;  //  pins you are using for I2C

int pageNum = 4;     //number of color pages - each page has 8 color selections
#define colorNum 32  //number of colors - should be divisible by 8

int selected_palette = 31;  //default color 0 to (colorNum-1)
int selected_gamma = 4;     //default brightness 0 to 7

bool SelectorOnStartup = false;  // set to true to automatically lauch the selector on startup
bool PrintSelection = false;    // set to true to have the color # and brightness level sent to serial monitor during the color selection. useful for finding defaults
...
const uint8_t allpalettes[colorNum + 1][3][16] = {
  ///////////page1////////////
  { //BuPu
  ...
  { //warm white
    { 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 },
    { 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 },
    { 5, 5, 10, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200 } },
  { //pink white
    { 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 },
    { 5, 10, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215 },
    { 5, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230 } },
  { //violet  white
    { 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 },
    { 0, 10, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215 },
    { 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 } },
  { //green white
    { 5, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230 },
    { 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 },
  ...
  { //cool white
    { 5, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230 },
    { 20, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230 },
    { 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 } },
  { //orange white
    { 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 },
    { 10, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230 },
    { 5, 10, 0, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200 } },
  { //teal white
    { 0, 5, 10, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200 },
    { 0, 20, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230 },
    { 0, 35, 50, 65, 80, 95, 110, 125, 140, 155, 170, 185, 200, 215, 230, 255 } },
  { //warmer white
  ...
  if (evt.bit.EDGE == SEESAW_KEYPAD_EDGE_RISING) {
    ...
    if ((x == 13 && y == 7) or (x == 14 && y == 7) or (x == 15 && y == 7)) {
      ...
      if (resetkeyspressed == 3) {
        allthreekeys = true;
        page = 0;  //need to reset page # otherwise will not enter color selector if page is > 0
      }
    }
...
*/
  ...
  setBright();
  setGamma(selected_gamma);  //setGamma(2);
  delay(300);
  mdp.setAllLEDs(0);
  sendLeds();
  monomeRefresh = 0;
